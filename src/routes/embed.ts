...
(function () {
  ...
  btn.style.cssText = "display:inline-flex;align-items:center;gap:8px;padding:12px 20px;border-radius:12px;background:#F5A623;color:#1a1a2e;font-family:system-ui,sans-serif;font-weight:600;font-size:14px;text-decoration:none;box-shadow:0 4px 14px rgba(245,166,35,.35);transition:transform .15s,box-shadow .15s;";
